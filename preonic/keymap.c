...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[FN] = LAYOUT_ortho_5x12(
		...
		RGB_MOD,	LGUI(KC_LEFT),	LGUI(KC_DOWN),	LGUI(KC_RGHT),	KC_NO,		KC_NO,	KC_NO,	KC_NO,	KC_NO,		KC_NO,	KC_NO,		KC_F12,
		KC_NO,		KC_NO,			KC_NO,			KC_NO,			KC_NO,		KC_NO,	KC_NO,	KC_NO,	KC_HOME,	KC_END,	KC_NO,		KC_NO,
		KC_PGDN,	KC_PGUP,		KC_TRNS,		KC_TRNS,		KC_MPLY,	KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,	KC_TRNS,LSG(KC_S),	KC_NO
	)
};
